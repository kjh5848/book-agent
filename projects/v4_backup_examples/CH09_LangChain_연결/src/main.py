"""
CH09 LangChain 연결 전략 — 실행 진입점.

커넥트HR AI 비서 LangChain Agent를 대화형 CLI로 실행합니다.
...
from monitoring import setup_logging, token_tracker
...
def main() -> None:
    ...
    """
    print_separator()
    print("커넥트HR AI 비서 — CH09 LangChain 연결 전략 예제")
    print_separator()
