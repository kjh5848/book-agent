...
POSTGRES_DB   = os.getenv("POSTGRES_DB",   "connect_hr")
POSTGRES_USER = os.getenv("POSTGRES_USER", "connect_hr")
POSTGRES_PASSWORD = os.getenv("POSTGRES_PASSWORD", "connect_hr_pass")
