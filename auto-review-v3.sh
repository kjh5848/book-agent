...
TARGET_DIR="$PROJECT_DIR/projects/RAG기술서_v3"
...
target = "/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트-claude/projects/RAG기술서_v3"
...
review_file = "/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트-claude/projects/RAG기술서_v3/review/review_progress.json"
...
print(f"""품질 검증 + 회고 파이프라인을 이어서 실행해줘.
